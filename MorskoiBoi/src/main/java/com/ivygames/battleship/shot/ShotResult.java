...
public class ShotResult {
    ...
    @NonNull
    public final Coordinate aim;
    @Nullable
    public final LocatedShip locatedShip;

    public ShotResult(@NonNull Coordinate aim, @NonNull Cell cell, @Nullable LocatedShip locatedShip) {
        this.cell = cell;
        this.aim = aim;
        this.locatedShip = locatedShip;
    }

    public ShotResult(@NonNull Coordinate aim, @NonNull Cell cell) {
        this.cell = cell;
        this.aim = aim;
