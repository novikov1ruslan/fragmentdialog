...
public final class SetupBoardGeometryProcessor extends BaseGeometryProcessor {
    ...
    @NonNull
    final Vector getPickedShipCoordinate(@NonNull Ship ship, @NonNull Point p) {
        return getPickedShipCoordinate(ship, p.x, p.y);
    }

    @NonNull
    final Vector getPickedShipCoordinate(@NonNull Ship ship, int x, int y) {
        mPickedShipRect = centerPickedShipRectAround(ship, x, y);
    ...
    @NonNull
    private Vector getPickedShipCoordinate(@NonNull Rect pickedShipRect) {
