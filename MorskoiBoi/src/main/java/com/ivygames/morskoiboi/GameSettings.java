...
public class GameSettings {
	...
	public int getProgressTipCounter() {
		return internal.getInt(SHOW_PROGRESS_TIPS, 0);
	}

	public void incrementProgressTipCounter() {
		internal.putInt(SHOW_PROGRESS_TIPS, getProgressTipCounter() + 1);
	}
