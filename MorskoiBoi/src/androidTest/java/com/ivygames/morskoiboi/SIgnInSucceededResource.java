...
public class SignInSucceededResource implements IdlingResource {

    private final Handler handler = new Handler(Looper.getMainLooper());
    private volatile boolean isTransitionRunning;
    private volatile ResourceCallback resourceCallback;

    public SignInSucceededResource(Runnable runnable) {
        runTransition(runnable);
    }

    @Override
    public String getName() {
        return SignInSucceededResource.class.getSimpleName();
    }
