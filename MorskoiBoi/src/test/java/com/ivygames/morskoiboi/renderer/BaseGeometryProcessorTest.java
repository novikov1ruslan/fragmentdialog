...
public class BaseGeometryProcessorTest {
    ...
    public void aiming_produces_correct_output_2() {
        ...
        int width = 1;
        int height = 4;
        AimingG aiming = mPresenter.getAimingG(Coordinate.get(i, j), width, height);
    ...
    public void getRectForShipThrowsExceptionWhenCalledBeforeMeasure() {
        mPresenter = new BaseGeometryProcessor(10, 2);
        mPresenter.getRectForShip(new Ship(1), Coordinate.get(5, 5));
    }
    ...
    public void getRectForShipHorizontal() {
        Rect rect = mPresenter.getRectForShip(new Ship(4, Ship.Orientation.HORIZONTAL), Coordinate.get(0, 0));
    ...
    public void getRectForShipVertical() {
        Rect rect = mPresenter.getRectForShip(new Ship(4, Ship.Orientation.VERTICAL), Coordinate.get(0, 0));
