...
public class RussianRulesTest {
    ...
    public void board_is_not_set_when_it_has_conflicting_cells_when_all_the_fleet_is_on_a_board() {
        ...
        Collection<Ship> ships = ShipUtils.generateFullFleet(allShipsSizes, orientationBuilder);
        for (Ship ship : ships) {
            Placement.putShipAt(board, new Board.LocatedShip(ship, 0, 0));
        }
    ...
    public void cell_is_not_conflicting_if_it_only_touched_by_1_ship2() {
        Board board = new Board();
        Ship ship = new Ship(1);
        Placement.putShipAt(board, new Board.LocatedShip(ship, 1, 5));
    ...
    public void cell_is_conflicting_if_it_is_occupied_by_ship_A_and_ship_B_is_touching_the_cell() {
        Board board = new Board();
        Ship ship = new Ship(1);
        Placement.putShipAt(board, new Board.LocatedShip(ship, 6, 6));

        Ship ship1 = new Ship(1);
        Placement.putShipAt(board, new Board.LocatedShip(ship1, 5, 5));
    ...
    public void max_scores_for_android_game_is_31250() {
        ...
        assertThat(mRules.calcTotalScores(ShipUtils.generateFullFleet(allShipsSizes, orientationBuilder), mAndroidGame,
    ...
    public void max_score_for_BT_game_is_5000() {
        ...
        assertThat(mRules.calcTotalScores(new ArrayList<Ship>(), mBluetoothGame, statistics,
    ...
    public void max_score_for_internet_game_is_5000() {
        ...
        assertThat(mRules.calcTotalScores(new ArrayList<Ship>(), mInternetGame, statistics,
    ...
    public void it_is_impossible_to_score_more_than_31250() {
        ...
        assertThat(mRules.calcTotalScores(ShipUtils.generateFullFleet(allShipsSizes, orientationBuilder), mAndroidGame, statistics,
                false), is(31250));
    }
    ...
    public void exactly_min_scores_equals_230() {
        ...
        int i = mRules.calcTotalScores(ships, mAndroidGame, statistics, false);
        assertThat(i, is(230));
    }
    ...
    public void it_is_impossible_to_score_less_than_230() {
        ...
        assertThat(mRules.calcTotalScores(ships, mAndroidGame, statistics,
                false), is(230));
    }
